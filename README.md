...
- mobx (⭐25.5k+️) - [13 contributions](https://github.com/mobxjs/mobx/pulls?q=is%3Apr+is%3Aclosed+author%3Akubk). Last PR - [Mock console.warn in tests and verify warnings are called in the right place](https://github.com/mobxjs/mobx/pull/3352) (merged)
...
- DefinitelyTyped (⭐40.0k+️) - [Add barRadius to the list of available options](https://github.com/DefinitelyTyped/DefinitelyTyped/pull/40737) (merged)
