...
- [php-converter](https://github.com/riverwaysoft/php-converter) - AST-based converter from PHP to API layer for TypeScript / Dart, so you don't have to maintain Open API spec. [~50000](https://packagist.org/packages/riverwaysoft/php-converter) total downloads, 2+ years in production
